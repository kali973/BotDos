...
function setThresholds() {
    ...
    setThreshold('ddos_protect_tcp_amplification',
        {
            metric: 'ddos_protect_tcp_amplification',
            value: settings.tcp_amplification.threshold,
            byFlow: true,
            timeout: threshold_t
        }
    );
    setThreshold('ddos_protect_tcp6_amplification',
        {
            metric: 'ddos_protect_tcp6_amplification',
            value: settings.tcp_amplification.threshold,
            byFlow: true,
            timeout: threshold_t
        }
    ...
    setThreshold('ddos_protect_udp_amplification',
        {
            metric: 'ddos_protect_udp_amplification',
            value: settings.udp_amplification.threshold,
            byFlow: true,
            timeout: threshold_t
        }
    );
    setThreshold('ddos_protect_udp6_amplification',
        {
            metric: 'ddos_protect_udp6_amplification',
            value: settings.udp_amplification.threshold,
            byFlow: true,
            timeout: threshold_t
        }
    ...
    setThreshold('ddos_protect_ip_fragmentation',
        {
            metric: 'ddos_protect_ip_fragmentation',
            value: settings.ip_fragmentation.threshold,
            byFlow: true,
            timeout: threshold_t
        }
    );
    setThreshold('ddos_protect_ip6_fragmentation',
        {
            metric: 'ddos_protect_ip6_fragmentation',
            value: settings.ip_fragmentation.threshold,
            byFlow: true,
            timeout: threshold_t
        }
    ...
    switch (path[0]) {
        case 'trend':
            ...
            Object.keys(settings).forEach(function (key) {
                result.trend.values['threshold_' + key] = settings[key].threshold;
            });
